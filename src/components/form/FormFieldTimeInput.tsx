...
function FormFieldTimeInput(props: FormFieldProps) {
  const {
    label,
  ...
  return (
    <FieldBase
      ...
      <TimeInput onChangeValue={handleTimeDisplayeOnChangeValue} defaultValue={defaultValue.current} />
      {/* </View> */}
    </FieldBase>
  );
}

export default FormFieldTimeInput;
